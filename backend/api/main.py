...
from backend.api.endpoints import vqa_router, caption_router, grounding_router, change_router, optical_sar_router, agent_router, land_cover_router, analyze_router, copernicus_router
...
app.include_router(copernicus_router, prefix="/api/v1", tags=["Copernicus Data Space"])
